...
if test ! -z "${BUILD_LIBS}"; then
	...
	# currently unused
	OPTIONAL_LIBS="cairo gdk-pixbuf ghostscript librsvg libspectre openjpeg pango ncurses"
	...
	BUILTIN_LIBS="glib pkg-config ${NO_DEPENDS} libXpm libiconv gettext libiconv-intl libpng xz \
libxml2 libjpeg-turbo jbigkit libtiff lcms2 libexif freetype harfbuzz freetype-hb fontconfig pcre \
pixman poppler libvorbis libflac SDL2 libmpg123 SDL2_mixer wxWidgets wxSVG"
fi
