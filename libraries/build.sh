...
if test ! -z "${BUILD_LIBS}"; then
	...
	# currently unused
	OPTIONAL_LIBS="cairo ghostscript librsvg libspectre pango ncurses libarchive \
...
glib-reb pixman openjpeg poppler libvorbis libflac SDL2 libmpg123 SDL2_mixer gdk-pixbuf wxWidgets \
wxSVG"
fi
