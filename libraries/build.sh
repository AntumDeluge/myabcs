...
BUILTIN_LIBS="pkg-config zlib libpng libiconv gettext libffi glib libexif expat harfbuzz freetype libogg libvorbis libflac SDL2 libmpg123 SDL2_mixer wxWidgets wxSVG"
