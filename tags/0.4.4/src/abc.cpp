            ...
            wxDEFAULT_FRAME_STYLE &~(wxRESIZE_BORDER|wxMAXIMIZE_BOX))
{
    ...
    cheer = new wxSound(*exedir + CHEER);
    ...
    // Tool Bar
	wxBitmap ico_exit(wxImage(*exedir + _T("pic/exit.png")));
	wxBitmap ico_abc(wxImage(*exedir + _T("pic/abc.png")));
	wxBitmap ico_anim(wxImage(*exedir + _T("pic/animals.png")));
	wxBitmap ico_food(wxImage(*exedir + _T("pic/food.png")));
	wxBitmap ico_inst(wxImage(*exedir + _T("pic/instrument.png")));
	wxBitmap ico_toys(wxImage(*exedir + _T("pic/toys.png")));
	...
	menu->AddSeparator();
	menu->AddTool(ID_HELP, _T("Help"), wxBitmap(wxImage(*exedir + _T("pic/help.png"))), wxNullBitmap, wxITEM_NORMAL,
		wxEmptyString, _T("Help"));
	menu->AddTool(wxID_ABOUT, _T("About"), wxBitmap(wxImage(*exedir + _T("pic/info.png"))), wxNullBitmap, wxITEM_NORMAL,
    ...
    image = new wxStaticBitmap(bg, -1, wxNullBitmap);
...
\n\
  Sounds:\n\
	...
	about->SetImage(*exedir + _T("icon.xpm"));
	about->SetName(_T("MyABCs"));
	about->SetVersion(_T("0.4"));
	...
	about->AddArtist(_T("Noodle"), _T("hextrust"), _T("Public Domain"));
	...
	about->AddArtist(_T("Pretzel"), _T("Jordan Irwin"), _T("Public Domain"));
	...
	about->AddArtist(_T("Yak"), _T("???"), _T("Copyleft"));
...
void MainWindow::SetMode(wxCommandEvent& event)
{
    ...
    else
    {
        ...
        if (id == ID_ABC)
        {
            ...
            image->SetBitmap(wxBitmap(wxImage(*exedir + images[0])));
        ...
        else
        {
            if (id == ID_ANIMALS)
            {
                ...
                image->SetBitmap(wxBitmap(wxImage(*exedir + TURTLE)));
            ...
            else if (id == ID_MUSIC)
            {
                ...
                image->SetBitmap(wxBitmap(wxImage(*exedir + GUITAR)));
            ...
            else if (id == ID_FOOD)
            {
                ...
                image->SetBitmap(wxBitmap(wxImage(*exedir + HOT_DOG)));
            ...
            else if (id == ID_TOYS)
            {
                ...
                image->SetBitmap(wxBitmap(wxImage(*exedir + WAGON)));
    ...
    if (!isplaying && cankey && canspace)
    {
        ...
        else
        {
            if (!gameend)
            {
                ...
                cur_sound = wxString::Format(*exedir + _T("sound/alpha/%c.wav"), key);
                ...
                if (menu->GetToolState(ID_ABC))
                {
                    ...
                    else if (key == WXK_BACK)
                    {
                        ...
                        for (int x = 26; x > 0; x -= 1)
                        {
                            ...
                            {
                                image->SetBitmap(wxBitmap(wxImage(*exedir + images[x-1])));
            ...
            else
            {
                if (keycode == WXK_BACK)
                {
                    ...
                    gameend = false;
                    cheer->Stop();
                    image->SetBitmap(wxBitmap(wxImage(*exedir + images[25])));
    ...
    if (key == cur_letter)
    {
        if (cur_letter != 'Z')
        {
            for (int a = 0; a < 26; a += 1)
            {
                if (letters[a] == key)
                {
                    image->SetBitmap(wxBitmap(wxImage(*exedir + images[a+1])));
        ...
        {
            gameend = true;
            image->SetBitmap(wxBitmap(wxImage(*exedir + RIBBON)));
...
void MainWindow::PlaySound()
{
    ...
    wxString sounds[2][131] =
    {
        ...
        _T("sound/dog.wav"), _T("sound/doll.wav"), _T("sound/dolphin.wav"), _T("sound/doughnut.wav"), _T("sound/drums.wav"),
        _T("sound/earth.wav"), _T("sound/easel.wav"), _T("sound/egg.wav"), _T("sound/eguitar.wav"), _T("sound/elephant.wav"),
        _T("sound/fire.wav"), _T("sound/flute.wav"), _T("sound/football.wav"), _T("sound/fries.wav"), _T("sound/frog.wav"),
        _T("sound/giraffe.wav"), _T("sound/glove.wav"), _T("sound/grapes.wav"), _T("sound/grasshopper.wav"), _T("sound/guitar.wav"),
        _T("sound/harp.wav"), _T("sound/horse.wav"), _T("sound/hat.wav"), _T("sound/horn.wav"), _T("sound/hot_dog.wav"),
        _T("sound/iguana.wav"), _T("sound/ice_cream.wav"), _T("sound/ice_skate.wav"), _T("sound/igloo.wav"), _T("sound/ipu.wav"),
        _T("sound/jaguar.wav"), _T("sound/jar.wav"), _T("sound/jug.wav"), _T("sound/juice.wav"), _T("sound/jump_rope.wav"),
        _T("sound/kazoo.wav"), _T("sound/ketchup.wav"), _T("sound/keyboard.wav"), _T("sound/kite.wav"), _T("sound/koala.wav"),
        _T("sound/ladybug.wav"), _T("sound/lasagna.wav"), _T("sound/lunchbox.wav"), _T("sound/lion.wav"), _T("sound/lute.wav"),
        _T("sound/magnet.wav"), _T("sound/mag_glass.wav"), _T("sound/maracas.wav"), _T("sound/mouse.wav"), _T("sound/mushroom.wav"),
        _T("sound/necklace.wav"), _T("sound/newspaper.wav"), _T("sound/newt.wav"), _T("sound/ney.wav"), _T("sound/noodle.wav"),
        _T("sound/oboe.wav"), _T("sound/olive.wav"), _T("sound/onion.wav"), _T("sound/origami.wav"), _T("sound/owl.wav"),
        _T("sound/paint.wav"), _T("sound/paper_plane.wav"), _T("sound/piano.wav"), _T("sound/pig.wav"), _T("sound/pretzel.wav"),
        _T("sound/quail.wav"), _T("sound/quarter.wav"), _T("sound/quena.wav"), _T("sound/quiche.wav"), _T("sound/quilt.wav"),
        _T("sound/raccoon.wav"), _T("sound/radishes.wav"), _T("sound/recorder.wav"), _T("sound/rocking_horse.wav"), _T("sound/rooster.wav"),
        _T("sound/sax.wav"), _T("sound/sheep.wav"), _T("sound/seesaw.wav"), _T("sound/star.wav"), _T("sound/strawberry.wav"),
        _T("sound/tomato.wav"), _T("sound/top.wav"), _T("sound/train.wav"), _T("sound/trumpet.wav"), _T("sound/turtle.wav"),
        _T("sound/udon.wav"), _T("sound/ukulele.wav"), _T("sound/umbrella.wav"), _T("sound/unagi.wav"), _T("sound/unicycle.wav"),
        _T("sound/urchin.wav"), _T("sound/vase.wav"), _T("sound/vegetables.wav"), _T("sound/violin.wav"), _T("sound/volleyball.wav"),
        _T("sound/vulture.wav"), _T("sound/wagon.wav"), _T("sound/watch.wav"), _T("sound/watermelon.wav"), _T("sound/whale.wav"),
        _T("sound/whistle.wav"), _T("sound/xcookie.wav"), _T("sound/xray.wav"), _T("sound/xiphias.wav"), _T("sound/xylophone.wav"),
...
void MainWindow::OnAbout(wxMenuEvent& event)
{
	...
	info.AddArtist(_T("All artwork is licensed under either the GNU Free Documentation License, Creative Commons, Copyleft or is released under the Public domain."));
	#ifdef WIN32
	info.SetIcon(ICON1);
	#endif
